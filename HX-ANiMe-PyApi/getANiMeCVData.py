...
if __name__ == '__main__':
    # 用户图表 apiKey
    apiKey = "ZVGuC3GySGcn0QVYkDvPz8zOJLvilCKZDX0WAjqcp"
    ...
    [
        ...
        165829, # 坂本ですが？
        235130, # ぐらんぶる (碧蓝之海)
        260677, # アズールレーン THE ANIMATION (碧蓝航线)
        272510, # まちカドまぞく (街角魔族)
        103127, # デンキ街の本屋さん (电器街的漫画店)
        241158, # となりの吸血鬼さん (邻家索菲)
        397604, # 亚托莉
        389571, # 物理魔法使-马修
        297624, # くまクマ熊ベアー
        93545,  # 甘城ブリリアントパーク
        2567,   # 生徒会の一存
        120925, # Charlotte (夏洛特)
        213076, # 妹さえいればいい
        252782, # 蜘蛛ですが、なにか?
        326895, # 夏日重现
        10440,  # あの日見た花の名前を僕達はまだ知らない (未闻花名)
        235612, # 工作细胞
        309668, # 异世界迷宫黑心企业
        1424,   # 轻音少女
        24790,  # 男子高校生の日常
        292970, # 魔女の旅々
        100040, # 天体のメソッド (天体的秩序)
        29648,  # 中二病でも恋がしたい！
        292969, # スライム倒して300年、知らないうちにレベルMAXになってました
        172498, # エロマンガ先生
        254374, # ネコぱら OVA Extra 仔ネコの日の約束
        282684, # のんのんびより のんすとっぷ
        120187, # 干物妹! うまるちゃん
        274234, # 小林さんちのメイドラゴンS
        13485,  # ロウきゅーぶ！ (萝球社)
        273843, # 动物狂想曲
        100449, # 月刊少女野崎くん
        276,    # 幸运星
